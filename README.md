...
I'm a **BS Artificial Intelligence** student at the **University of Karachi** and a hands-on **AI & Automation Engineer** — not the "studies AI, hasn't shipped anything" kind. I design and deploy **multi-agent AI systems**, build **production automation pipelines**, and ship full-stack products end-to-end.

At **Radiant Solutions RS**, I've designed and deployed **15+ enterprise automation workflows** that cut client operational costs by **40–60%**, architected a full **B2B lead-generation system** wiring together Claude AI, Gemini, MCP servers, and CRM logic, and managed production **Oracle Cloud VPS infrastructure** with Docker, Cloudflare tunnels, and self-hosted LLMs.

I've also competed in back-to-back hackathons — building a **3-agent cyberpunk mobile game** in 5 days for Google's AISeekho 2026, and a **6-agent fantasy RPG** grounded in Microsoft Foundry IQ for the Microsoft Agents League Hackathon.

```yaml
role: AI & Agentic Systems Developer
focus: Multi-Agent Orchestration · Workflow Automation · LLM Integration
currently_building: Production-grade agentic systems & automation pipelines
open_to: AI Engineer · Agentic Systems Developer · AI Automation Engineer roles
```
...
|:---|:---:|:---|
| **Multi-Agent Orchestration** | ●●●●● | Designed 3–6 agent systems with role-based dispatch, shared state & dynamic trust logic |
| **LLM Integration** | ●●●●● | Claude, Gemini, Groq LLaMA 3.3 70B, OpenRouter — prompt design & grounded retrieval |
| **Workflow Automation** | ●●●●● | n8n, Zapier — 15+ production workflows, webhook/API orchestration |
| **MCP Servers** | ●●●●○ | Vibe Prospecting, custom tool integration via Model Context Protocol |
| **Machine Learning** | ●●●●○ | Scikit-learn, XGBoost — EDA, feature engineering, model comparison |
| **RAG / Grounded Retrieval** | ●●●●○ | Microsoft Foundry IQ (Azure AI Search) for cited, hallucination-free lore retrieval |
...
<details open>
<summary><b>🏰 Chronicles of Eldervale — Multi-Agent Fantasy RPG</b></summary>
<br/>

A 6-agent fantasy RPG system built for the **Microsoft Agents League Hackathon** (Reasoning Agents track, Challenge B). A Game Master orchestrator agent dispatches to five character agents — Warrior, Mage, Rogue, Healer, and Rival — each with independent personality, memory, and reasoning, grounded in **Microsoft Foundry IQ** for hallucination-free world lore.

| | |
|---|---|
| **Stack** | Python · Flask · Groq LLaMA 3.3 70B · Microsoft Foundry IQ (Azure AI Search) |
| **Scale** | 6 coordinated agents · 24 grounded lore chunks · 7-step reasoning pipeline per turn |
| **Performance** | Real-time agent dispatch with dice resolution and persistent JSON state |
| **Security** | Fully synthetic world data — no real PII, credentials isolated via `.env` |
| **Impact** | Hackathon submission demonstrating grounded, citation-backed multi-agent reasoning |
| **Repository** | [chronicles-eldervale-](https://github.com/SyedWaqarAliZaidi/chronicles-eldervale-) |
...
<details>
<summary><b>🚗 Car Price Prediction — ML & Exploratory Data Analysis</b></summary>
<br/>

End-to-end machine learning pipeline analyzing **19,000+ real-world car records**, answering five analytical questions through visualization, then training and comparing five regression models to find the best price predictor.
...
End-to-end automation pipeline for lead discovery, AI-powered scoring, pain-point analysis, and personalized outreach generation — with voice + text input via Slack and automated CRM sync.
...
**Radiant Solutions RS (Pvt) Ltd** · Karachi, Pakistan
`Oct 2025 — Mar 2026`

- Designed and deployed **15+ AI automation workflows** using n8n and Zapier for enterprise clients across diverse industries
- Reduced client operational costs by **40–60%** through intelligent process automation and API integration
- Built a complete **B2B Lead Generation pipeline** integrating Claude AI, Gemini, Vibe Prospecting MCP, and Google Sheets CRM with deduplication logic
- Architected and managed **Oracle Cloud VPS**, Docker, SSH tunneling, Linux firewall, Cloudflare tunnels, and local LLM deployment via Ollama
- Developed custom SaaS solutions and led projects from concept to production deployment

`Python` `n8n` `Claude AI` `Docker` `Oracle Cloud` `Cloudflare` `Ollama` `MCP Servers`
...
| **Microsoft Agents League Hackathon** | Built Chronicles of Eldervale — a 6-agent reasoning RPG grounded in Foundry IQ |
| **Independent Client Acquisition** | Acquired and delivered for independent clients in AI automation services |
| **Production Automation Impact** | Deployed 15+ workflows reducing client costs by 40–60% |
| **Public Speaking & Leadership** | 20+ co-curricular awards in debates, public speaking, and leadership |
| **GDGoK Member** | Active member, Google Developer Groups on Campus — University of Karachi |
...
current_focus:
  learning:
    ...
    - Production-grade RAG & grounded retrieval systems
  building:
    - Agentic automation pipelines for real client workloads
    - DSA fundamentals — algorithms & problem-solving practice
  exploring:
    - MCP server ecosystems & custom tool integrations
    - Self-hosted LLM infrastructure on Oracle Cloud
  open_to:
    - AI Engineer
